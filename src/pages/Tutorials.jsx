            ...
            >
              <div className="p-6">
                ...
                >
                  {activeVideo === tutorial.id ? (
                    ...
                    <div className="w-full h-full bg-gray-200 rounded-md flex items-center justify-center">
                      <img
                        className="w-full h-36 text-gray-400"
                ...
                <button
                  ...
                  } w-full text-white py-2 px-4 rounded-md  transition duration-300 ease-in-out focus:outline-none focus:ring-2  focus:ring-opacity-50`}
                >
                  {activeVideo === tutorial.id
                    ? "Now Playing"
                    : "Watch Tutorial"}
